...
module.exports.fork = opts => {
	const defaultOption = (opts && opts.silent && !opts.stdio) ? 'pipe' : 'inherit';
	...
	if (typeof stdioOption === 'string') {
		...
		stdioOption = stdioOption.map(channel => channel === undefined ? defaultOption : channel);
	}
