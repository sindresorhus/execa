...
const normalizeTransform = ({stdioItem, stdioItem: {type}, index, newTransforms, direction, encoding}) => type === 'duplex'
	? normalizeDuplex({stdioItem})
...
const normalizeDuplex = ({
	...
	stdioItem: {
		value: {
			duplex,
			duplex: {writableObjectMode, readableObjectMode},
		},
	},
}) => ({
	...stdioItem,
	value: {duplex, writableObjectMode, readableObjectMode},
});
