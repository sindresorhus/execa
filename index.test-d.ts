...
const pipeInherit = ['pipe' as const, 'inherit' as const];
const pipeUndefined = ['pipe' as const, undefined];

const fileUrl = new URL('file:///test');
const fileObject = {file: './test'};
const invalidFileObject = {file: fileUrl};

const stringArray = ['foo', 'bar'];
const binaryArray = [new Uint8Array(), new Uint8Array()];
const objectArray = [{}, {}];
...
const duplexWithInvalidObjectMode = {...duplex, objectMode: 'true'};
...
const webTransformWithInvalidObjectMode = {...webTransform, objectMode: 'true'};

const unknownGenerator = function * (line: unknown) {
	yield line;
};

const unknownGeneratorFull = {transform: unknownGenerator, objectMode: true};

const unknownFinal = function * () {
	yield {} as unknown;
};

const unknownFinalFull = {transform: unknownGenerator, final: unknownFinal, objectMode: true};

const objectGenerator = function * (line: unknown) {
	yield JSON.parse(line as string) as object;
};

const objectGeneratorFull = {transform: objectGenerator, objectMode: true};

const objectFinal = function * () {
	yield {};
};

const objectFinalFull = {transform: objectGenerator, final: objectFinal, objectMode: true};

const booleanGenerator = function * (line: boolean) {
	yield line;
};

const booleanGeneratorFull = {transform: booleanGenerator};

const stringGenerator = function * (line: string) {
	yield line;
};

const stringGeneratorFull = {transform: stringGenerator};
...
const invalidReturnGeneratorFull = {transform: invalidReturnGenerator};
...
const invalidReturnFinalFull = {transform: stringGenerator, final: invalidReturnFinal};

const asyncGenerator = async function * (line: unknown) {
	yield '';
};

const asyncGeneratorFull = {transform: asyncGenerator};

const asyncFinal = async function * () {
	yield '';
};

const asyncFinalFull = {transform: asyncGenerator, final: asyncFinal};

const transformWithBinary = {transform: unknownGenerator, binary: true};
const transformWithInvalidBinary = {transform: unknownGenerator, binary: 'true'};
const transformWithPreserveNewlines = {transform: unknownGenerator, preserveNewlines: true};
const transformWithInvalidPreserveNewlines = {transform: unknownGenerator, preserveNewlines: 'true'};
const transformWithObjectMode = {transform: unknownGenerator, objectMode: true};
const transformWithInvalidObjectMode = {transform: unknownGenerator, objectMode: 'true'};
const binaryOnly = {binary: true};
const preserveNewlinesOnly = {preserveNewlines: true};
const objectModeOnly = {objectMode: true};
const finalOnly = {final: unknownFinal};
...
expectError(execaSync('unicorns', {stdin: pipeInherit}));
execa('unicorns', {stdout: pipeInherit});
expectError(execaSync('unicorns', {stdout: pipeInherit}));
execa('unicorns', {stderr: pipeInherit});
expectError(execaSync('unicorns', {stderr: pipeInherit}));
execa('unicorns', {stdio: ['pipe', 'pipe', 'pipe', pipeInherit]});
expectError(execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', pipeInherit]}));
expectAssignable<StdinOption>(pipeInherit);
expectNotAssignable<StdinOptionSync>(pipeInherit);
expectAssignable<StdoutStderrOption>(pipeInherit);
expectNotAssignable<StdoutStderrOptionSync>(pipeInherit);
expectAssignable<StdioOption>(pipeInherit);
expectNotAssignable<StdioOptionSync>(pipeInherit);
...
execa('unicorns', {stdin: [0]});
expectError(execaSync('unicorns', {stdin: [0]}));
...
execa('unicorns', {stderr: [2]});
expectError(execaSync('unicorns', {stderr: [2]}));
...
execa('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [3]]});
expectError(execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [3]]}));
expectAssignable<StdinOption>(0);
expectAssignable<StdinOptionSync>(0);
expectAssignable<StdinOption>([0]);
expectNotAssignable<StdinOptionSync>([0]);
...
expectAssignable<StdoutStderrOption>([2]);
expectNotAssignable<StdoutStderrOptionSync>([2]);
expectAssignable<StdioOption>(3);
expectAssignable<StdioOptionSync>(3);
expectAssignable<StdioOption>([3]);
expectNotAssignable<StdioOptionSync>([3]);
...
execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', new Uint8Array()]});
execa('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [new Uint8Array()]]});
execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [new Uint8Array()]]});
...
expectError(execaSync('unicorns', {stdin: [stringArray]}));
...
expectNotAssignable<StdinOptionSync>([stringArray]);
...
expectNotAssignable<StdioOptionSync>([stringArray]);
execa('unicorns', {stdin: [binaryArray]});
expectError(execaSync('unicorns', {stdin: [binaryArray]}));
...
expectNotAssignable<StdinOptionSync>([binaryArray]);
...
expectNotAssignable<StdioOptionSync>([binaryArray]);
...
expectNotAssignable<StdinOptionSync>([objectArray]);
...
expectNotAssignable<StdioOptionSync>([objectArray]);
execa('unicorns', {stdin: stringIterable});
expectError(execaSync('unicorns', {stdin: stringIterable}));
execa('unicorns', {stdin: [stringIterable]});
expectError(execaSync('unicorns', {stdin: [stringIterable]}));
...
expectNotAssignable<StdinOptionSync>(stringIterable);
expectAssignable<StdinOption>([stringIterable]);
expectNotAssignable<StdinOptionSync>([stringIterable]);
...
expectNotAssignable<StdioOptionSync>(stringIterable);
expectAssignable<StdioOption>([stringIterable]);
expectNotAssignable<StdioOptionSync>([stringIterable]);
execa('unicorns', {stdin: binaryIterable});
expectError(execaSync('unicorns', {stdin: binaryIterable}));
execa('unicorns', {stdin: [binaryIterable]});
expectError(execaSync('unicorns', {stdin: [binaryIterable]}));
...
expectNotAssignable<StdinOptionSync>(binaryIterable);
expectAssignable<StdinOption>([binaryIterable]);
expectNotAssignable<StdinOptionSync>([binaryIterable]);
...
expectNotAssignable<StdioOptionSync>(binaryIterable);
expectAssignable<StdioOption>([binaryIterable]);
expectNotAssignable<StdioOptionSync>([binaryIterable]);
execa('unicorns', {stdin: objectIterable});
expectError(execaSync('unicorns', {stdin: objectIterable}));
execa('unicorns', {stdin: [objectIterable]});
expectError(execaSync('unicorns', {stdin: [objectIterable]}));
...
expectNotAssignable<StdinOptionSync>(objectIterable);
expectAssignable<StdinOption>([objectIterable]);
expectNotAssignable<StdinOptionSync>([objectIterable]);
...
expectNotAssignable<StdioOptionSync>(objectIterable);
expectAssignable<StdioOption>([objectIterable]);
expectNotAssignable<StdioOptionSync>([objectIterable]);
...
expectError(execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', unknownGenerator]}));
execa('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [unknownGenerator]]});
expectError(execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [unknownGenerator]]}));
expectAssignable<StdinOption>(unknownGenerator);
expectNotAssignable<StdinOptionSync>(unknownGenerator);
expectAssignable<StdinOption>([unknownGenerator]);
expectNotAssignable<StdinOptionSync>([unknownGenerator]);
expectAssignable<StdoutStderrOption>(unknownGenerator);
expectNotAssignable<StdoutStderrOptionSync>(unknownGenerator);
expectAssignable<StdoutStderrOption>([unknownGenerator]);
expectNotAssignable<StdoutStderrOptionSync>([unknownGenerator]);
expectAssignable<StdioOption>(unknownGenerator);
expectNotAssignable<StdioOptionSync>(unknownGenerator);
expectAssignable<StdioOption>([unknownGenerator]);
expectNotAssignable<StdioOptionSync>([unknownGenerator]);
execa('unicorns', {stdin: unknownGeneratorFull});
expectError(execaSync('unicorns', {stdin: unknownGeneratorFull}));
execa('unicorns', {stdin: [unknownGeneratorFull]});
expectError(execaSync('unicorns', {stdin: [unknownGeneratorFull]}));
...
expectError(execaSync('unicorns', {stderr: unknownGeneratorFull}));
execa('unicorns', {stderr: [unknownGeneratorFull]});
expectError(execaSync('unicorns', {stderr: [unknownGeneratorFull]}));
...
expectNotAssignable<StdinOptionSync>(unknownGeneratorFull);
expectAssignable<StdinOption>([unknownGeneratorFull]);
expectNotAssignable<StdinOptionSync>([unknownGeneratorFull]);
expectAssignable<StdoutStderrOption>(unknownGeneratorFull);
expectNotAssignable<StdoutStderrOptionSync>(unknownGeneratorFull);
expectAssignable<StdoutStderrOption>([unknownGeneratorFull]);
expectNotAssignable<StdoutStderrOptionSync>([unknownGeneratorFull]);
expectAssignable<StdioOption>(unknownGeneratorFull);
expectNotAssignable<StdioOptionSync>(unknownGeneratorFull);
expectAssignable<StdioOption>([unknownGeneratorFull]);
expectNotAssignable<StdioOptionSync>([unknownGeneratorFull]);
execa('unicorns', {stdin: unknownFinalFull});
expectError(execaSync('unicorns', {stdin: unknownFinalFull}));
execa('unicorns', {stdin: [unknownFinalFull]});
expectError(execaSync('unicorns', {stdin: [unknownFinalFull]}));
execa('unicorns', {stdout: unknownFinalFull});
expectError(execaSync('unicorns', {stdout: unknownFinalFull}));
execa('unicorns', {stdout: [unknownFinalFull]});
expectError(execaSync('unicorns', {stdout: [unknownFinalFull]}));
execa('unicorns', {stderr: unknownFinalFull});
expectError(execaSync('unicorns', {stderr: unknownFinalFull}));
execa('unicorns', {stderr: [unknownFinalFull]});
expectError(execaSync('unicorns', {stderr: [unknownFinalFull]}));
...
expectNotAssignable<StdinOptionSync>(unknownFinalFull);
expectAssignable<StdinOption>([unknownFinalFull]);
expectNotAssignable<StdinOptionSync>([unknownFinalFull]);
expectAssignable<StdoutStderrOption>(unknownFinalFull);
expectNotAssignable<StdoutStderrOptionSync>(unknownFinalFull);
expectAssignable<StdoutStderrOption>([unknownFinalFull]);
expectNotAssignable<StdoutStderrOptionSync>([unknownFinalFull]);
expectAssignable<StdioOption>(unknownFinalFull);
expectNotAssignable<StdioOptionSync>(unknownFinalFull);
expectAssignable<StdioOption>([unknownFinalFull]);
expectNotAssignable<StdioOptionSync>([unknownFinalFull]);
execa('unicorns', {stdin: objectGenerator});
expectError(execaSync('unicorns', {stdin: objectGenerator}));
execa('unicorns', {stdin: [objectGenerator]});
expectError(execaSync('unicorns', {stdin: [objectGenerator]}));
execa('unicorns', {stdout: objectGenerator});
expectError(execaSync('unicorns', {stdout: objectGenerator}));
execa('unicorns', {stdout: [objectGenerator]});
expectError(execaSync('unicorns', {stdout: [objectGenerator]}));
execa('unicorns', {stderr: objectGenerator});
expectError(execaSync('unicorns', {stderr: objectGenerator}));
execa('unicorns', {stderr: [objectGenerator]});
expectError(execaSync('unicorns', {stderr: [objectGenerator]}));
...
expectNotAssignable<StdinOptionSync>(objectGenerator);
expectAssignable<StdinOption>([objectGenerator]);
expectNotAssignable<StdinOptionSync>([objectGenerator]);
expectAssignable<StdoutStderrOption>(objectGenerator);
expectNotAssignable<StdoutStderrOptionSync>(objectGenerator);
expectAssignable<StdoutStderrOption>([objectGenerator]);
expectNotAssignable<StdoutStderrOptionSync>([objectGenerator]);
expectAssignable<StdioOption>(objectGenerator);
expectNotAssignable<StdioOptionSync>(objectGenerator);
expectAssignable<StdioOption>([objectGenerator]);
expectNotAssignable<StdioOptionSync>([objectGenerator]);
execa('unicorns', {stdin: objectGeneratorFull});
expectError(execaSync('unicorns', {stdin: objectGeneratorFull}));
execa('unicorns', {stdin: [objectGeneratorFull]});
expectError(execaSync('unicorns', {stdin: [objectGeneratorFull]}));
execa('unicorns', {stdout: objectGeneratorFull});
expectError(execaSync('unicorns', {stdout: objectGeneratorFull}));
execa('unicorns', {stdout: [objectGeneratorFull]});
expectError(execaSync('unicorns', {stdout: [objectGeneratorFull]}));
execa('unicorns', {stderr: objectGeneratorFull});
expectError(execaSync('unicorns', {stderr: objectGeneratorFull}));
execa('unicorns', {stderr: [objectGeneratorFull]});
expectError(execaSync('unicorns', {stderr: [objectGeneratorFull]}));
...
expectNotAssignable<StdinOptionSync>(objectGeneratorFull);
expectAssignable<StdinOption>([objectGeneratorFull]);
expectNotAssignable<StdinOptionSync>([objectGeneratorFull]);
expectAssignable<StdoutStderrOption>(objectGeneratorFull);
expectNotAssignable<StdoutStderrOptionSync>(objectGeneratorFull);
expectAssignable<StdoutStderrOption>([objectGeneratorFull]);
expectNotAssignable<StdoutStderrOptionSync>([objectGeneratorFull]);
expectAssignable<StdioOption>(objectGeneratorFull);
expectNotAssignable<StdioOptionSync>(objectGeneratorFull);
expectAssignable<StdioOption>([objectGeneratorFull]);
expectNotAssignable<StdioOptionSync>([objectGeneratorFull]);
...
expectError(execaSync('unicorns', {stdout: objectFinalFull}));
execa('unicorns', {stdout: [objectFinalFull]});
expectError(execaSync('unicorns', {stdout: [objectFinalFull]}));
execa('unicorns', {stderr: objectFinalFull});
expectError(execaSync('unicorns', {stderr: objectFinalFull}));
execa('unicorns', {stderr: [objectFinalFull]});
expectError(execaSync('unicorns', {stderr: [objectFinalFull]}));
...
expectNotAssignable<StdinOptionSync>(objectFinalFull);
expectAssignable<StdinOption>([objectFinalFull]);
expectNotAssignable<StdinOptionSync>([objectFinalFull]);
expectAssignable<StdoutStderrOption>(objectFinalFull);
expectNotAssignable<StdoutStderrOptionSync>(objectFinalFull);
expectAssignable<StdoutStderrOption>([objectFinalFull]);
expectNotAssignable<StdoutStderrOptionSync>([objectFinalFull]);
expectAssignable<StdioOption>(objectFinalFull);
expectNotAssignable<StdioOptionSync>(objectFinalFull);
expectAssignable<StdioOption>([objectFinalFull]);
expectNotAssignable<StdioOptionSync>([objectFinalFull]);
...
expectError(execaSync('unicorns', {stdin: transformWithBinary}));
execa('unicorns', {stdin: [transformWithBinary]});
expectError(execaSync('unicorns', {stdin: [transformWithBinary]}));
execa('unicorns', {stdout: transformWithBinary});
expectError(execaSync('unicorns', {stdout: transformWithBinary}));
execa('unicorns', {stdout: [transformWithBinary]});
expectError(execaSync('unicorns', {stdout: [transformWithBinary]}));
execa('unicorns', {stderr: transformWithBinary});
expectError(execaSync('unicorns', {stderr: transformWithBinary}));
execa('unicorns', {stderr: [transformWithBinary]});
expectError(execaSync('unicorns', {stderr: [transformWithBinary]}));
...
expectError(execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', transformWithBinary]}));
execa('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [transformWithBinary]]});
expectError(execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [transformWithBinary]]}));
expectAssignable<StdinOption>(transformWithBinary);
expectNotAssignable<StdinOptionSync>(transformWithBinary);
expectAssignable<StdinOption>([transformWithBinary]);
expectNotAssignable<StdinOptionSync>([transformWithBinary]);
expectAssignable<StdoutStderrOption>(transformWithBinary);
expectNotAssignable<StdoutStderrOptionSync>(transformWithBinary);
expectAssignable<StdoutStderrOption>([transformWithBinary]);
expectNotAssignable<StdoutStderrOptionSync>([transformWithBinary]);
expectAssignable<StdioOption>(transformWithBinary);
expectNotAssignable<StdioOptionSync>(transformWithBinary);
expectAssignable<StdioOption>([transformWithBinary]);
expectNotAssignable<StdioOptionSync>([transformWithBinary]);
...
expectError(execaSync('unicorns', {stdin: transformWithPreserveNewlines}));
execa('unicorns', {stdin: [transformWithPreserveNewlines]});
expectError(execaSync('unicorns', {stdin: [transformWithPreserveNewlines]}));
execa('unicorns', {stdout: transformWithPreserveNewlines});
expectError(execaSync('unicorns', {stdout: transformWithPreserveNewlines}));
execa('unicorns', {stdout: [transformWithPreserveNewlines]});
expectError(execaSync('unicorns', {stdout: [transformWithPreserveNewlines]}));
execa('unicorns', {stderr: transformWithPreserveNewlines});
expectError(execaSync('unicorns', {stderr: transformWithPreserveNewlines}));
execa('unicorns', {stderr: [transformWithPreserveNewlines]});
expectError(execaSync('unicorns', {stderr: [transformWithPreserveNewlines]}));
...
expectError(execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', transformWithPreserveNewlines]}));
execa('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [transformWithPreserveNewlines]]});
expectError(execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [transformWithPreserveNewlines]]}));
expectAssignable<StdinOption>(transformWithPreserveNewlines);
expectNotAssignable<StdinOptionSync>(transformWithPreserveNewlines);
expectAssignable<StdinOption>([transformWithPreserveNewlines]);
expectNotAssignable<StdinOptionSync>([transformWithPreserveNewlines]);
expectAssignable<StdoutStderrOption>(transformWithPreserveNewlines);
expectNotAssignable<StdoutStderrOptionSync>(transformWithPreserveNewlines);
expectAssignable<StdoutStderrOption>([transformWithPreserveNewlines]);
expectNotAssignable<StdoutStderrOptionSync>([transformWithPreserveNewlines]);
expectAssignable<StdioOption>(transformWithPreserveNewlines);
expectNotAssignable<StdioOptionSync>(transformWithPreserveNewlines);
expectAssignable<StdioOption>([transformWithPreserveNewlines]);
expectNotAssignable<StdioOptionSync>([transformWithPreserveNewlines]);
...
expectError(execaSync('unicorns', {stdin: transformWithObjectMode}));
execa('unicorns', {stdin: [transformWithObjectMode]});
expectError(execaSync('unicorns', {stdin: [transformWithObjectMode]}));
execa('unicorns', {stdout: transformWithObjectMode});
expectError(execaSync('unicorns', {stdout: transformWithObjectMode}));
execa('unicorns', {stdout: [transformWithObjectMode]});
expectError(execaSync('unicorns', {stdout: [transformWithObjectMode]}));
...
expectError(execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', transformWithObjectMode]}));
execa('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [transformWithObjectMode]]});
expectError(execaSync('unicorns', {stdio: ['pipe', 'pipe', 'pipe', [transformWithObjectMode]]}));
expectAssignable<StdinOption>(transformWithObjectMode);
expectNotAssignable<StdinOptionSync>(transformWithObjectMode);
expectAssignable<StdinOption>([transformWithObjectMode]);
expectNotAssignable<StdinOptionSync>([transformWithObjectMode]);
expectAssignable<StdoutStderrOption>(transformWithObjectMode);
expectNotAssignable<StdoutStderrOptionSync>(transformWithObjectMode);
expectAssignable<StdoutStderrOption>([transformWithObjectMode]);
expectNotAssignable<StdoutStderrOptionSync>([transformWithObjectMode]);
expectAssignable<StdioOption>(transformWithObjectMode);
expectNotAssignable<StdioOptionSync>(transformWithObjectMode);
expectAssignable<StdioOption>([transformWithObjectMode]);
expectNotAssignable<StdioOptionSync>([transformWithObjectMode]);
