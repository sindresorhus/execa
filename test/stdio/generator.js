...
const getOutputObjectMode = (objectMode, addNoopTransform, isDuplex, binary) => objectMode
	? {
		generators: generatorsMap[isDuplex].addNoop(generatorsMap[isDuplex].outputObject(), addNoopTransform, objectMode, binary),
		output: [foobarObject],
		getStreamMethod: getStreamAsArray,
	}
	: {
		generators: generatorsMap[isDuplex].addNoop(generatorsMap[isDuplex].uppercaseBuffer(objectMode, true), addNoopTransform, objectMode, binary),
		output: foobarUppercase,
