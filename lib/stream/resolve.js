...
import {waitForSubprocessStreams} from './subprocess.js';
import {getBufferedData} from './contents.js';
...
export const getSubprocessResult = async ({
	...
	const stdioPromises = waitForSubprocessStreams({subprocess, encoding, buffer, maxBuffer, lines, stripFinalNewline, verboseInfo, streamInfo});
	const allPromise = waitForAllStream({subprocess, encoding, buffer, maxBuffer, lines, stripFinalNewline, verboseInfo, streamInfo});
