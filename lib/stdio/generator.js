...
export const generatorToDuplexStream = ({
	...
	const generators = addInternalGenerators(value, optionName);
...
export const getGenerators = stdioItems => stdioItems.filter(({type}) => type === 'generator');
...
const addInternalGenerators = (
	...
	return [
		...
		getEncodingTransformGenerator(binary, writableObjectMode),
