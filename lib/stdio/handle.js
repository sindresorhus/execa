...
const getFileDescriptor = ({stdioOption, fdNumber, addProperties, options, isSync, stdioState, verboseInfo}) => {
	...
	const normalizedStdioItems = normalizeStdioItems({stdioItems, fdNumber, optionName, addProperties, options, direction, stdioState, verboseInfo});
...
const normalizeStdioItems = ({stdioItems, fdNumber, optionName, addProperties, options, direction, stdioState, verboseInfo}) => {
	const allStdioItems = addInternalStdioItems({stdioItems, fdNumber, optionName, options, stdioState, verboseInfo});
...
const addInternalStdioItems = ({stdioItems, fdNumber, optionName, options, stdioState, verboseInfo}) => willPipeFileDescriptor(stdioItems)
	? [
		...stdioItems,
