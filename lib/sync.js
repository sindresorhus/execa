...
export const execaSync = (rawFile, rawArgs, rawOptions) => {
	...
	const result = spawnProcessSync({file, args, options, command, escapedCommand, stdioStreamsGroups, startTime});
...
const spawnProcessSync = ({file, args, options, command, escapedCommand, stdioStreamsGroups, startTime}) => {
	let syncResult;
	try {
