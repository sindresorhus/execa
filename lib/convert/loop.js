...
import {transformChunkSync, finalChunksSync} from '../stdio/transform-sync.js';
...
const iterateOnStream = ({stream, controller, binary, shouldEncode, encoding, shouldSplit, preserveNewlines}) => {
	...
	return iterateOnData({onStdoutChunk, controller, binary, shouldEncode, encoding, shouldSplit, preserveNewlines});
};
