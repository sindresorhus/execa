...
export const getSplitLinesGenerator = (binary, preserveNewlines, writableObjectMode, state) => binary || writableObjectMode
	? undefined
	: initializeSplitLines(preserveNewlines, state);

export const splitLinesSync = (string, preserveNewlines) => {
	const {transform, final} = initializeSplitLines(preserveNewlines, {});
	return [...transform(string), ...final()];
};
