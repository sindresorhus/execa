...
test('Cannot use killSignal: Infinity', testInvalidKillSignal, Infinity, 'other', execa);
test('Cannot use killSignal: NaN', testInvalidKillSignal, NaN, 'other', execa);
...
test('Cannot use killSignal: Infinity, sync', testInvalidKillSignal, Infinity, 'other', execaSync);
test('Cannot use killSignal: NaN, sync', testInvalidKillSignal, NaN, 'other', execaSync);
...
test('Cannot use subprocess.kill(Infinity)', testInvalidSignalArgument, Infinity, 'other');
test('Cannot use subprocess.kill(NaN)', testInvalidSignalArgument, NaN, 'other');
