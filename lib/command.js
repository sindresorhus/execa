...
const parseExpression = expression => {
	if (typeof expression === 'object' && expression !== null && 'stdout' in expression) {
		return Buffer.isBuffer(expression.stdout)
			? expression.stdout.toString()
			: String(expression.stdout);
	}
