...
import {handleInputAsync} from './stdio/async.js';
import {pipeOutputAsync} from './stdio/output-async.js';
...
import {SUBPROCESS_OPTIONS} from './convert/fd-options.js';
...
const handleAsyncArguments = (rawFile, rawArgs, rawOptions) => {
	...
	try {
		...
		const fileDescriptors = handleInputAsync(options, verboseInfo);
