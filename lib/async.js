...
export const execa = (rawFile, rawArgs, rawOptions) => {
	...
	subprocess.pipe = pipeToSubprocess.bind(undefined, {source: subprocess, sourcePromise: promise, stdioStreamsGroups, destinationOptions: {}});
	mergePromise(subprocess, promise);
	SUBPROCESS_OPTIONS.set(subprocess, options);
	return subprocess;
};
